...
intl = read.csv("mit_analytics-edge/unit_7/intl.csv")
str(intl)
...
intlall = read.csv("mit_analytics-edge/unit_7/intlall.csv",stringsAsFactors=FALSE)
...
households = read.csv("mit_analytics-edge/unit_7/households.csv")
str(households)
