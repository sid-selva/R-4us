...
# Read in the data
stevens = read.csv("mit_analytics-edge/unit_4/data/stevens.csv")
str(stevens)
...
PredictROC
# Predicts the prob that the observation is a 0 or 1 

pred = prediction(PredictROC[,2], Test$Reverse) # Using the second column 
...
# Bagged a random observation , and do DT, Observation size is node size 
